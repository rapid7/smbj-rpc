...
public class Test_Packet {
    ...
    public void getStringAligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x0c, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x0c, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00, 0x20, 0x00, 0x57, 0x00,
    ...
    public void getStringUnaligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x0b, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x0b, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00, 0x20, 0x00, 0x57, 0x00,
    ...
    public void getStringUnalignedNullTerminated() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
            0x0d, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00, 0x20, 0x00, 0x57, 0x00,
            0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertEquals("Hello World!", packet.getString(true));
    }

    @Test
    public void getNullStringRef() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringRef(false));
    }

    @Test
    public void getNullStringRefNullTerminated() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x00, 0x00 }));
    ...
    public void getStringRefAligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x04, 0x00, 0x02, 0x00, 0x0c, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00,
    ...
    public void getStringRefUnaligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x04, 0x00, 0x02, 0x00, 0x0b, 0x00, 0x00, 0x00,
            0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00,
    ...
    public void getStringRefUnalignedNullTerminated() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x04, 0x00, 0x02, 0x00, 0x0d, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0d,
                0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00, 0x20, 0x00, 0x57, 0x00,
                0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x21, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertEquals("Hello World!", packet.getStringRef(true));
    }

    @Test
    public void getStringBufAligned() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x18, 0x00, 0x18, 0x00, 0x00, 0x00, 0x02, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x00,
                ...
                0x20, 0x00, 0x57, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x21, 0x00 }));
        assertEquals("Hello World!", packet.getStringBuf(false));
    }

    @Test
    public void getStringBufUnaligned() {
        final Packet packet = new Packet(
    ...
    @Test
    public void getStringBufAlignedNullTerminated() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x18, 0x00, 0x18, 0x00, 0x00, 0x00, 0x02, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f, 0x00,
                0x20, 0x00, 0x57, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x00, 0x00 }));
        assertEquals("Hello World", packet.getStringBuf(true));
    }

    @Test
    public void getStringBufUnalignedNullTerminated() {
    ...
    @Test
    public void getNullStringBuf() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBuf(false));
    }

    @Test
    public void getNullStringBufNullTerminated() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBuf(true));
    }

    @Test
    public void getStringBufRefAligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(
            new byte[] { 0x00, 0x00, 0x02, 0x00, 0x18, 0x00, 0x18, 0x00, 0x04, 0x00, 0x02, 0x00, 0x0c, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f,
                0x00, 0x20, 0x00, 0x57, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x21, 0x00 }));
        assertEquals("Hello World!", packet.getStringBufRef(false));
    }

    @Test
    public void getStringBufRefUnaligned() {
        final Packet packet = new Packet(ByteBuffer.wrap(
            new byte[] { 0x00, 0x00, 0x02, 0x00, 0x16, 0x00, 0x16, 0x00, 0x04, 0x00, 0x02, 0x00, 0x0b, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x0b, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f,
                0x00, 0x20, 0x00, 0x57, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x00, 0x00 }));
    ...
    @Test
    public void getStringBufRefAlignedNullTerminated() {
        final Packet packet = new Packet(ByteBuffer.wrap(
            new byte[] { 0x00, 0x00, 0x02, 0x00, 0x18, 0x00, 0x18, 0x00, 0x04, 0x00, 0x02, 0x00, 0x0c, 0x00, 0x00, 0x00,
                0x00, 0x00, 0x00, 0x00, 0x0c, 0x00, 0x00, 0x00, 0x48, 0x00, 0x65, 0x00, 0x6c, 0x00, 0x6c, 0x00, 0x6f,
                0x00, 0x20, 0x00, 0x57, 0x00, 0x6f, 0x00, 0x72, 0x00, 0x6c, 0x00, 0x64, 0x00, 0x00, 0x00 }));
        assertEquals("Hello World", packet.getStringBufRef(true));
    }

    @Test
    public void getStringBufRefUnalignedNullTerminated() {
    ...
    @Test
    public void getOuterNullStringBufRef() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBufRef(false));
    }

    @Test
    public void getOuterNullStringBufRefNullTerminated() {
        final Packet packet = new Packet(ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBufRef(true));
    }

    @Test
    public void getInnerNullStringBufRef() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBufRef(false));
    }
    ...
    @Test
    public void getInnerNullStringBufRefNullTerminated() {
        final Packet packet = new Packet(
            ByteBuffer.wrap(new byte[] { 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 }));
        assertNull(packet.getStringBufRef(true));
    }
