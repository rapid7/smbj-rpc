 ...
 */
public class SamrDeleteAliasRequest extends RequestCall<SamrDeleteAliasResponse> {
	public static final short OP_NUM = 30;
	...
	public SamrDeleteAliasRequest(AliasHandle aliasHandle) {
		super(OP_NUM);
		this.aliasHandle = aliasHandle;
	}
	@Override
	public SamrDeleteAliasResponse getResponseObject() { return new SamrDeleteAliasResponse(); }
	@Override
	public void marshal(PacketOutput packetOut) throws IOException {
		// <NDR: fixed array> [in, out] SAMPR_HANDLE AliasHandle
		packetOut.write(getAliasHandle().getBytes());
	}
}
