...
/**
 * This class represents domain display information for a machine.
 */
public class DomainDisplayMachine extends DomainDisplay {
    ...
    public String toString() {
        ...
        return String.format("DomainDisplayMachine{relativeID: %d, name: %s, comment: %s, accountControl: %d}",
